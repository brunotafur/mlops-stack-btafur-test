...
Refer to [Local development and dev workspace](../btafur_mlops_project/resources/README.md#local-development-and-dev-workspace) 
...
You can iterate on the sample ML code by running the provided `btafur_mlops_project/training/notebooks/Train.py` notebook on Databricks using
