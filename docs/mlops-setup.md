...
[ML Config](../btafur_mlops_project/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore btafur_mlops_project/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://e2-demo-west.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://e2-demo-west.cloud.databricks.com#setting/accounts). If
...
* [databricks-dev.yaml](../btafur_mlops_project/training/profiles/databricks-dev.yaml): specify recipe configs to use in dev workspace
* [databricks-staging.yaml](../btafur_mlops_project/training/profiles/databricks-staging.yaml): specify recipe configs to use in recurring model training and batch inference
  jobs that run in the staging workspace
* [databricks-prod.yaml](../btafur_mlops_project/training/profiles/databricks-prod.yaml) specify recipe configs to use in recurring model training and batch inference
  jobs that run in the prod workspace
* [databricks-test.yaml](../btafur_mlops_project/training/profiles/databricks-test.yaml): specify recipe configs to use in integration tests(CI)
...
Follow the instructions in [btafur-mlops-project/resources/README.md](../btafur_mlops_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../btafur_mlops_project/resources/README.md)  to propose, test, and deploy
