...
Opening a pull request will trigger a[workflow](../.github/workflows/btafur-mlops-project-run-tests.yml) 
...
* [Staging workspace registered model](https://e2-demo-west.cloud.databricks.com#mlflow/models/staging-btafur-mlops-project-model)
* [Prod workspace registered model](https://e2-demo-west.cloud.databricks.com#mlflow/models/prod-btafur-mlops-project-model)
