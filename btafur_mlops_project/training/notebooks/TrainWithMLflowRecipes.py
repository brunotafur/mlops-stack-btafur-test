...
# ``btafur_mlops_project/resources/model-workflow-resource.yml``
#
...
if config['experiment']['name'].startswith(f"/{env}-btafur-mlops-project-experiment"):
    print("WARNING: The experiment name may not have been set correctly. Please confirm that the experiment name in the profile YAML file matches the experiment_name variable in btafur_mlops_project/databricks.yml.")
